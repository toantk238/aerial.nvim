...
## [3.0.0](https://github.com/toantk238/aerial.nvim/compare/v2.3.1...v3.0.0) (2024-12-06)


### ⚠ BREAKING CHANGES

* drop support for Neovim 0.8 ([#387](https://github.com/toantk238/aerial.nvim/issues/387))
* ignore win/buffer behavior prevents opening aerial at all ([#204](https://github.com/toantk238/aerial.nvim/issues/204))
* drop support for nvim <0.8
* Link aerial to a source window, not a buffer ([#128](https://github.com/toantk238/aerial.nvim/issues/128))
* split close_behavior into two new config options
* Remove ability to use g:aerial variables to configure

### doc

* drop support for nvim &lt;0.8 ([e633b81](https://github.com/toantk238/aerial.nvim/commit/e633b816507e3948a8fd9702069a641b38e919cc))


### cleanup

* Remove ability to use g:aerial variables to configure ([a1c0fa1](https://github.com/toantk238/aerial.nvim/commit/a1c0fa13754594a950d805fd3e416f279255d40e))


### Features

* add custom backend to support man pages ([#164](https://github.com/toantk238/aerial.nvim/issues/164)) ([7e03dd4](https://github.com/toantk238/aerial.nvim/commit/7e03dd48472f51ed24184e6818efc0b63e51dca9))
* add highlight groups to lualine text components ([cb679ac](https://github.com/toantk238/aerial.nvim/commit/cb679ac16d5c2e6c2c204b0542dc369c7b5d59dc))
* add layout.resize_to_content config option ([c4714a6](https://github.com/toantk238/aerial.nvim/commit/c4714a6e37f74629591bf50b51a085314f8abd68))
* add lualine separator highlight and optional prefix ([#287](https://github.com/toantk238/aerial.nvim/issues/287)) ([f34defe](https://github.com/toantk238/aerial.nvim/commit/f34defe8f5c2d27f49d53fe0269b87a16f1fb1b9))
* add mouse binding to jump to symbol ([#104](https://github.com/toantk238/aerial.nvim/issues/104)) ([2ba3f7a](https://github.com/toantk238/aerial.nvim/commit/2ba3f7afcdd332eaeb9316ed84d08c807556b6b2))
* add new `AerialNormal` highlight as a fallback for all text ([#278](https://github.com/toantk238/aerial.nvim/issues/278)) ([b4eb257](https://github.com/toantk238/aerial.nvim/commit/b4eb257e5422eafbdd577f5b1c9f83ca0359ab7b))
* add refetch_symbols API method ([#280](https://github.com/toantk238/aerial.nvim/issues/280)) ([1f15722](https://github.com/toantk238/aerial.nvim/commit/1f1572285725663deb4ec3afece2decabfdca16b))
* add resession extension ([f7d6ca8](https://github.com/toantk238/aerial.nvim/commit/f7d6ca898b32f00c29037d399ab6bba77b2a2ad9))
* add solidity treesitter support ([#273](https://github.com/toantk238/aerial.nvim/issues/273)) ([7c2a432](https://github.com/toantk238/aerial.nvim/commit/7c2a432238b9c8e8c526619fa003e658691ea127))
* add support for `mini.icons` ([#383](https://github.com/toantk238/aerial.nvim/issues/383)) ([3d910b2](https://github.com/toantk238/aerial.nvim/commit/3d910b2ba0b8536bb708467690b6685f1783cb19))
* add support for vim help files ([#164](https://github.com/toantk238/aerial.nvim/issues/164)) ([817be1d](https://github.com/toantk238/aerial.nvim/commit/817be1d211be9ff8acf6eac4d205b1a3b4dbffed))
* add to jumplist before jumping ([#424](https://github.com/toantk238/aerial.nvim/issues/424)) ([247df21](https://github.com/toantk238/aerial.nvim/commit/247df216704cbe3cfa68e2ae5515c3485e281364))
* Adds syntax highlighting in the telescope picker ([#386](https://github.com/toantk238/aerial.nvim/issues/386)) ([4e77964](https://github.com/toantk238/aerial.nvim/commit/4e77964569ef47a70f9bb76c668dcfea2d089d5a))
* allow manage_folds to be a filetype map ([88b5192](https://github.com/toantk238/aerial.nvim/commit/88b519239940079b57d7077d728a2b0897b00923))
* autojump config option ([#244](https://github.com/toantk238/aerial.nvim/issues/244)) ([50ee951](https://github.com/toantk238/aerial.nvim/commit/50ee9515f35104ddc2f1a28480beeea1357cf355))
...
* center the current symbol after opening aerial ([#165](https://github.com/toantk238/aerial.nvim/issues/165)) ([26f0320](https://github.com/toantk238/aerial.nvim/commit/26f0320e959b786dea8513c3be0e46c69e68efc0))
* color lualine icons ([#155](https://github.com/toantk238/aerial.nvim/issues/155)) ([6f1b28b](https://github.com/toantk238/aerial.nvim/commit/6f1b28b549147c2f9e09de16869fcc34cf076253))
* config callback for first symbols ([c08aeea](https://github.com/toantk238/aerial.nvim/commit/c08aeea399ffe14a36ac9c5a85b73c5cb6471470))
* display ignore status in AerialInfo ([a562b9d](https://github.com/toantk238/aerial.nvim/commit/a562b9d99f5d87ed645fcd6256746619bcae2dc8))
* **elixir:** support parameterless functions ([#277](https://github.com/toantk238/aerial.nvim/issues/277)) ([603ffde](https://github.com/toantk238/aerial.nvim/commit/603ffde23a3834ff6fdafd0db448347337792c10))
* experimental support for navigating to symbol names ([#279](https://github.com/toantk238/aerial.nvim/issues/279)) ([e54cae0](https://github.com/toantk238/aerial.nvim/commit/e54cae0df0dc4a368beb705de2f5d2139ce5c062))
* expose window-local options in config ([#176](https://github.com/toantk238/aerial.nvim/issues/176)) ([1eb6d23](https://github.com/toantk238/aerial.nvim/commit/1eb6d23742aca676f5de1cc123b0045eaa12ca48))
* **fzf:** various improvements ([#275](https://github.com/toantk238/aerial.nvim/issues/275)) ([66078ea](https://github.com/toantk238/aerial.nvim/commit/66078ea0fa3589fea8f267672422773ca73ca68d))
* highlight parent symbol in Nav UI ([#380](https://github.com/toantk238/aerial.nvim/issues/380)) ([db0af49](https://github.com/toantk238/aerial.nvim/commit/db0af491ff13c18a966ce2f9ac7f5211aec000a7))
* icons can be defined as per-filetype map ([#108](https://github.com/toantk238/aerial.nvim/issues/108)) ([ae97872](https://github.com/toantk238/aerial.nvim/commit/ae9787240c4f97e28fb8c5b8c6ba96ee6fcd80d1))
* include receiver in golang methods ([#194](https://github.com/toantk238/aerial.nvim/issues/194)) ([661d0ad](https://github.com/toantk238/aerial.nvim/commit/661d0adaa43a20fb692e01261b6afb0841318617))
* **java:** add support for constructors ([8b8129e](https://github.com/toantk238/aerial.nvim/commit/8b8129e7306449dbc9fefb246f55ac3ee88d92a5))
* jest support for tsx ([#47](https://github.com/toantk238/aerial.nvim/issues/47)) ([2b71abb](https://github.com/toantk238/aerial.nvim/commit/2b71abbcc3c6aac93715b7a9761644076c030286))
* jest support for typescript ([#47](https://github.com/toantk238/aerial.nvim/issues/47)) ([960cf86](https://github.com/toantk238/aerial.nvim/commit/960cf86d9a2317dc9c0d9e0e58f84945383a3050))
* **just:** treesitter support for Just ([#401](https://github.com/toantk238/aerial.nvim/issues/401)) ([bb95e7f](https://github.com/toantk238/aerial.nvim/commit/bb95e7fed7e3d3dc0714722ef6ef57ea1b708a6a))
* keymap table accepts all vim.keymap.set opts ([#179](https://github.com/toantk238/aerial.nvim/issues/179)) ([5dd0904](https://github.com/toantk238/aerial.nvim/commit/5dd090432e9672e09ecdbdd83b6dd769bac34298))
* lazier loading for third party plugins ([4c6f8aa](https://github.com/toantk238/aerial.nvim/commit/4c6f8aaa043bda67497c2c3cfb0700af57b11d08))
* lazy loading technically works ([20618f2](https://github.com/toantk238/aerial.nvim/commit/20618f26ad62c58770ea85ef698100569c7b892f))
...
* map g? to show aerial buffer keymaps ([3c8a70c](https://github.com/toantk238/aerial.nvim/commit/3c8a70c88c46b468262d2a98a27d48c4abd818b3))
* nav view can preview symbol in rightmost column ([#235](https://github.com/toantk238/aerial.nvim/issues/235)) ([055d220](https://github.com/toantk238/aerial.nvim/commit/055d2209ad04b032b883f66b907f1dd50bcde01b))
* New commands for opening/closing multiple windows ([#100](https://github.com/toantk238/aerial.nvim/issues/100)) ([19e7391](https://github.com/toantk238/aerial.nvim/commit/19e739139283c8ac5e2c147f870d2a038496688e))
* new navigation view ([#235](https://github.com/toantk238/aerial.nvim/issues/235)) ([4b725dc](https://github.com/toantk238/aerial.nvim/commit/4b725dc8e59f6e43fff16912841bfc170d034b7d))
* new option layout.preserve_equality to keep window sizes equal ([#192](https://github.com/toantk238/aerial.nvim/issues/192)) ([65ca35c](https://github.com/toantk238/aerial.nvim/commit/65ca35c66cab9d854d17cb41c87490859775e05b))
* open_in_win to open aerial in an existing window ([#248](https://github.com/toantk238/aerial.nvim/issues/248)) ([d8f2699](https://github.com/toantk238/aerial.nvim/commit/d8f2699f7ae0e5eb62424d7b2ad80ce30179ee92))
...
* pass is_collapsed to get_highlight config function ([#257](https://github.com/toantk238/aerial.nvim/issues/257)) ([b154c0c](https://github.com/toantk238/aerial.nvim/commit/b154c0cbe096a7479a89ed32175831a97b0c5a1a))
* priority ranking for LSP clients ([#222](https://github.com/toantk238/aerial.nvim/issues/222)) ([7af6f81](https://github.com/toantk238/aerial.nvim/commit/7af6f812e41a28b19ddc1f7709374d4d765f8c78))
* **proto:** add treesitter query for grpc in proto filetype ([#404](https://github.com/toantk238/aerial.nvim/issues/404)) ([92f93f4](https://github.com/toantk238/aerial.nvim/commit/92f93f4e155b2135fc47ed2daf8b63f40726b545))
* **queries:** add basic yaml support ([c29e53a](https://github.com/toantk238/aerial.nvim/commit/c29e53a1b8199847d4d54a708c8ec0c0a9ab4338))
* **queries:** add norg support ([cefd62b](https://github.com/toantk238/aerial.nvim/commit/cefd62bda3e63c9b7371fa0fbae5910cf8b05087))
* **queries:** add teal support ([f645a4f](https://github.com/toantk238/aerial.nvim/commit/f645a4fe1ad8d48a18f76569c177e60e3266b47f))
* race symbol backends on first fetch ([#177](https://github.com/toantk238/aerial.nvim/issues/177)) ([45de4de](https://github.com/toantk238/aerial.nvim/commit/45de4de76f1bb90f956281b4699df9b058417784))
* return line and column number for each symbol in get_location API ([d5b405e](https://github.com/toantk238/aerial.nvim/commit/d5b405e79b0f0aadda3265cfe1e75651f05e2b0f))
...
* show hierarchy of symbols in telescope picker ([a30aa79](https://github.com/toantk238/aerial.nvim/commit/a30aa7991689545f4ee2259c4f44466d15952672))
* some options can be set on a per-buffer basis ([#280](https://github.com/toantk238/aerial.nvim/issues/280)) ([cd44627](https://github.com/toantk238/aerial.nvim/commit/cd446279f1606c3f44e0e0a8aedbc417f4a9a4d8))
* **starlark:** treesitter support for Starlark ([#402](https://github.com/toantk238/aerial.nvim/issues/402)) ([e585934](https://github.com/toantk238/aerial.nvim/commit/e585934fef8d253dbc5655cff3deb3444e064e6c))
...
* telescope selector uses current symbol for default_selection_index ([#161](https://github.com/toantk238/aerial.nvim/issues/161)) ([89a61da](https://github.com/toantk238/aerial.nvim/commit/89a61daba8da7c7cebc36fe9ddfeb0b5f8663e50))
* telescope show_nesting opt can be a filetype map ([c5436fd](https://github.com/toantk238/aerial.nvim/commit/c5436fdafd63dd4d0fe61987dd5aa2a821a05874))
* **telescope:** can provide custom function to format symbols ([#395](https://github.com/toantk238/aerial.nvim/issues/395)) ([eeebf32](https://github.com/toantk238/aerial.nvim/commit/eeebf32fcb365c860248fee785ae5923831bf2ad))
...
* **toml:** treesitter support for TOML tables ([#396](https://github.com/toantk238/aerial.nvim/issues/396)) ([263beeb](https://github.com/toantk238/aerial.nvim/commit/263beeb92961c15882b7853805f0ae2024f2e903))
* tree can set collapse level ([c892e2e](https://github.com/toantk238/aerial.nvim/commit/c892e2ea82a3d420b6425eb3d5137b8f4ca1d687))
* tree mutations take a bufnr ([b247ef5](https://github.com/toantk238/aerial.nvim/commit/b247ef50c7e5c5e5a78fce45880c1a4db9150667))
* treesitter support for latex ([#137](https://github.com/toantk238/aerial.nvim/issues/137)) ([1c666a6](https://github.com/toantk238/aerial.nvim/commit/1c666a62a27d65118354ba70679bc44d08f90715))
* treesitter supports markdown setext_heading ([#276](https://github.com/toantk238/aerial.nvim/issues/276)) ([de460a4](https://github.com/toantk238/aerial.nvim/commit/de460a4a29491af46eaf2108e6f7534c7b66c4a0))
* **treesitter:** add XML support ([#405](https://github.com/toantk238/aerial.nvim/issues/405)) ([0a2cf2b](https://github.com/toantk238/aerial.nvim/commit/0a2cf2b120121c50a7c28f021fb2c36f6ba1c533))
...
* **ts:** add ruby support for ruby operator methods ([#292](https://github.com/toantk238/aerial.nvim/issues/292)) ([fa8c408](https://github.com/toantk238/aerial.nvim/commit/fa8c408b76269a1ce5f17078d4f6cceb8e7e0114))
* **ts:** Add support for elixir ([897d4bd](https://github.com/toantk238/aerial.nvim/commit/897d4bd85279ac73cc9c8ed20ace203efb974b6a))
* **ts:** support for more solidity symbols ([#290](https://github.com/toantk238/aerial.nvim/issues/290)) ([bed048d](https://github.com/toantk238/aerial.nvim/commit/bed048ddef3e7b7fd992bc3a28c413aaa25d63de))
* **ts:** treesitter supports variables in python ([#227](https://github.com/toantk238/aerial.nvim/issues/227)) ([1e0c546](https://github.com/toantk238/aerial.nvim/commit/1e0c546c2c451737c769d601e3935ef9267d25dd))
...
* add guards for unloaded buffers ([#296](https://github.com/toantk238/aerial.nvim/issues/296)) ([d7577c6](https://github.com/toantk238/aerial.nvim/commit/d7577c6bd4714a61f255d685964f6bc0f5ae2474))
* add interface type to golang treesitter backend ([#180](https://github.com/toantk238/aerial.nvim/issues/180)) ([480bf14](https://github.com/toantk238/aerial.nvim/commit/480bf143325171c1f4003f6b3e82ade98b5f9bc3))
* add nil check to source window id ([9e0b28a](https://github.com/toantk238/aerial.nvim/commit/9e0b28a1a92062473964d9bb5aeca05c8f6dfd7f))
* add treesitter support for JS / TS / TSX generator functions ([#289](https://github.com/toantk238/aerial.nvim/issues/289)) ([9bcfbaf](https://github.com/toantk238/aerial.nvim/commit/9bcfbaf7a7d4ad31f234b4a6a1af6bb959838c26))
* aerial ignores diff windows ([#299](https://github.com/toantk238/aerial.nvim/issues/299)) ([c383f45](https://github.com/toantk238/aerial.nvim/commit/c383f45ec061031635488079f52f765c6986b7de))
* aerial split starts at size 1 ([3c39fb3](https://github.com/toantk238/aerial.nvim/commit/3c39fb38a59b7de4b8c5b8211113771fdd791d97))
* aerial tree collapse state shouldn't affect get_location ([#163](https://github.com/toantk238/aerial.nvim/issues/163)) ([c248731](https://github.com/toantk238/aerial.nvim/commit/c2487319c083bc1da3aecf21e054c6cf1bbda9b3))
* aerial.prev with no arguments ([93c6ceb](https://github.com/toantk238/aerial.nvim/commit/93c6cebee668e202328a9b39f6d2866a328c01c9))
* AerialClose closes other wins if buf has no symbols ([#95](https://github.com/toantk238/aerial.nvim/issues/95)) ([f1dfb0a](https://github.com/toantk238/aerial.nvim/commit/f1dfb0a05cd87f21175f33b3c8f4fbe4b1d77f18))
...
* always close keymap help window ([17f97fd](https://github.com/toantk238/aerial.nvim/commit/17f97fd2ca8acd055108c91c0c6406d0fb395396))
* apply kind filter after treesitter postprocessing ([b947110](https://github.com/toantk238/aerial.nvim/commit/b947110e9b009414acd80c78d56379a58deee2e4))
...
* bad method names from refactor ([05fff54](https://github.com/toantk238/aerial.nvim/commit/05fff54b2fe315d0f3a00dc1bf0196b61ffcdf2e))
...
* buffer mismatch in LSP symbols call ([#130](https://github.com/toantk238/aerial.nvim/issues/130)) ([551c43c](https://github.com/toantk238/aerial.nvim/commit/551c43c70ae793cd2bbbaa1c45b72c938f579567))
* bug about splitkeep (fix [#199](https://github.com/toantk238/aerial.nvim/issues/199)) ([c28ce50](https://github.com/toantk238/aerial.nvim/commit/c28ce509925be66ad82706470bc0554e16756404))
* C++ struct variables appear as symbols ([#153](https://github.com/toantk238/aerial.nvim/issues/153)) ([f1e0f0e](https://github.com/toantk238/aerial.nvim/commit/f1e0f0ea3b50aa929d003617e3cef1776f5f324d))
...
* catch all splitkeep access errors ([4c3ff75](https://github.com/toantk238/aerial.nvim/commit/4c3ff7554d4853b5b6372c9c4a5077076977ceb7))
* changing foldlevel updates tree correctly ([#120](https://github.com/toantk238/aerial.nvim/issues/120)) ([bd29cd1](https://github.com/toantk238/aerial.nvim/commit/bd29cd16218767cc8ac93d47d077cd4d19b0c43a))
...
* check validity of buffer in deferred callbacks ([4f36dee](https://github.com/toantk238/aerial.nvim/commit/4f36deee7331a21ee32f0730aa0ebad09e38c570))
* close_on_select applies to split/vsplit jumps ([#191](https://github.com/toantk238/aerial.nvim/issues/191)) ([5392fc1](https://github.com/toantk238/aerial.nvim/commit/5392fc192a4becbaaf57f7eadfe7780b1577ed1b))
* close_on_select will no longer affect preview ([4c588bd](https://github.com/toantk238/aerial.nvim/commit/4c588bd12567b500838d33d36336f146fa43b0b9))
* correctly fetch splitkeep option value ([4428a47](https://github.com/toantk238/aerial.nvim/commit/4428a478e70f6a6b52e86d16ced677020267f409))
...
* crash when no symbols in aerial win ([3a482fe](https://github.com/toantk238/aerial.nvim/commit/3a482fe4ac035af6b3849cb6b7c761973f5ff70f))
* cursor doesn't jump when opening tree ([e5a1965](https://github.com/toantk238/aerial.nvim/commit/e5a1965999c32cb4be2e84f226afda2cb69bbab8))
* default highlight group in nav view is NormalFloat ([#281](https://github.com/toantk238/aerial.nvim/issues/281)) ([2a6498f](https://github.com/toantk238/aerial.nvim/commit/2a6498f4b5f8e52557eadbcd2b3f91da8fe438ca))
...
* delay require of lspkind and nvim-web-devicons ([b9cde18](https://github.com/toantk238/aerial.nvim/commit/b9cde181c39a8aad139a559d6458a2b544c4e552))
...
* deprecated treesitter API in nvim nightly ([a6b86fd](https://github.com/toantk238/aerial.nvim/commit/a6b86fd357f184ad9f146245f8d34c9df0f424fa))
* deprecation message for up commands ([7339efd](https://github.com/toantk238/aerial.nvim/commit/7339efd9ab61e0ab1d79a8c59995b93405d3c8d9))
* disable all resizing when resize_to_content = false ([075b0fa](https://github.com/toantk238/aerial.nvim/commit/075b0fac9066d2c272ae800c63f23753536564c8))
* display symbols that occupy the same location ([#132](https://github.com/toantk238/aerial.nvim/issues/132)) ([7a8da21](https://github.com/toantk238/aerial.nvim/commit/7a8da219c8109cee0aa15d437959165d50a4130a))
* do not open_automatic in unsupported buffers ([#185](https://github.com/toantk238/aerial.nvim/issues/185)) ([047e19d](https://github.com/toantk238/aerial.nvim/commit/047e19de0421a6c3f2c0954b950cf8f53728c4c4))
...
* don't collapse uncollapsable leaf nodes ([#268](https://github.com/toantk238/aerial.nvim/issues/268)) ([c30fb2c](https://github.com/toantk238/aerial.nvim/commit/c30fb2c9bd09592351eed676f4c20e7a6411020e))
* don't default to lazy initialization if open_automatic = true ([#203](https://github.com/toantk238/aerial.nvim/issues/203)) ([ea86cd2](https://github.com/toantk238/aerial.nvim/commit/ea86cd2b05081873d3ae12fcf2aa77b59b7f11fd))
* don't ignore help buftypes by default ([#204](https://github.com/toantk238/aerial.nvim/issues/204)) ([7acdd61](https://github.com/toantk238/aerial.nvim/commit/7acdd616eebb1e96ddcd5966da85bf466264004f))
...
* don't set up aerial win/buf more than once ([#166](https://github.com/toantk238/aerial.nvim/issues/166)) ([e3dbe2b](https://github.com/toantk238/aerial.nvim/commit/e3dbe2b2928561bf76e23a3b049b783abb42f736))
* enforce treesitter backend uses LSP SymbolKind values ([#219](https://github.com/toantk238/aerial.nvim/issues/219)) ([06c6b4c](https://github.com/toantk238/aerial.nvim/commit/06c6b4c8eba1a903d1f972ec06ff0c4da26072df))
* error on missing splitkeep option ([#202](https://github.com/toantk238/aerial.nvim/issues/202)) ([92914ca](https://github.com/toantk238/aerial.nvim/commit/92914ca691755f111420224e1800168c4371059c))
* error when aerial is open on unsupported window ([767181b](https://github.com/toantk238/aerial.nvim/commit/767181b649852fa34865366508b79c329c357bc8))
* error when centering aerial symbol in view ([#165](https://github.com/toantk238/aerial.nvim/issues/165)) ([6a8fd67](https://github.com/toantk238/aerial.nvim/commit/6a8fd67801649e1d7105328d3a93df6bea1d3dbe))
* error when opening aerial in float ([#133](https://github.com/toantk238/aerial.nvim/issues/133)) ([9e0bbcd](https://github.com/toantk238/aerial.nvim/commit/9e0bbcde994881942030d6456b743cc199ceaacf))
* error when opening nav view on file with no symbols ([#256](https://github.com/toantk238/aerial.nvim/issues/256)) ([30316db](https://github.com/toantk238/aerial.nvim/commit/30316db63d816993b70621e8248437251d57076b))
* error when switching buffers ([8d0915b](https://github.com/toantk238/aerial.nvim/commit/8d0915b1f8257950092df3f47e40ac2abd7b3725))
* error with close_automatic_events = 'unsupported' ([#175](https://github.com/toantk238/aerial.nvim/issues/175)) ([6b1e97e](https://github.com/toantk238/aerial.nvim/commit/6b1e97efb7a22c2d4f3c255da8d91456f183444d))
* escape % in lualine component ([937a4af](https://github.com/toantk238/aerial.nvim/commit/937a4af150def677bbd816d7036f5dce5f561a46))
* guard against invalid buffers ([#207](https://github.com/toantk238/aerial.nvim/issues/207)) ([e2b6cd0](https://github.com/toantk238/aerial.nvim/commit/e2b6cd07b45f8457ea183d16e483fdac3581b04f))
* guard against invalid window ID errors ([#152](https://github.com/toantk238/aerial.nvim/issues/152)) ([b3f8df4](https://github.com/toantk238/aerial.nvim/commit/b3f8df4c7a75ac9b9e4290df9e1b36eacf087c9b))
* guides don't pick up italics from Comment group ([#182](https://github.com/toantk238/aerial.nvim/issues/182)) ([d22daba](https://github.com/toantk238/aerial.nvim/commit/d22daba7af04ffa0363e8fbb0e1c06eab79c647d))
* hack around LSP server not reporting symbol name ([#126](https://github.com/toantk238/aerial.nvim/issues/126)) ([86b8341](https://github.com/toantk238/aerial.nvim/commit/86b8341bb8c58ece7e7f3f9b2d0310f4a328ab21))
* help parser has been renamed to vimdoc ([bc2bc8b](https://github.com/toantk238/aerial.nvim/commit/bc2bc8b5d0daacc7ecb14d4dbe3c2516dbb6945e))
* ignore win/buffer behavior prevents opening aerial at all ([#204](https://github.com/toantk238/aerial.nvim/issues/204)) ([b1e6c7d](https://github.com/toantk238/aerial.nvim/commit/b1e6c7d94b293f682cfb474333838094f321b5e7))
* improper window behavior when attach_mode = 'global' ([#185](https://github.com/toantk238/aerial.nvim/issues/185)) ([e161ad5](https://github.com/toantk238/aerial.nvim/commit/e161ad5f4712428d923f9a8603601344b63a9ab9))
* improve code folding logic; support zm/zr ([3b3ed01](https://github.com/toantk238/aerial.nvim/commit/3b3ed01a7acfcdad7e5b4daead4a681d00c0ec5c))
* include buffer in LSP no support message ([#236](https://github.com/toantk238/aerial.nvim/issues/236)) ([00cac8e](https://github.com/toantk238/aerial.nvim/commit/00cac8e96f932dca8f559849cbea3f0812621d0d))
* incorrect folding for top level tree entries ([#178](https://github.com/toantk238/aerial.nvim/issues/178)) ([bf80cba](https://github.com/toantk238/aerial.nvim/commit/bf80cbacc54fc85dd8330e0974e6c37fa3da3737))
* invalid buffer id ([#170](https://github.com/toantk238/aerial.nvim/issues/170)) ([31c2304](https://github.com/toantk238/aerial.nvim/commit/31c2304397c73d004b8b621f4afbacbabf5eea86))
* **java:** don't start methods at annotations ([#417](https://github.com/toantk238/aerial.nvim/issues/417)) ([60a7846](https://github.com/toantk238/aerial.nvim/commit/60a784614acb1d7695bd9ae0fee8ada1bf7b0c28))
...
* julia treesitter queries for updated julia parser ([3423358](https://github.com/toantk238/aerial.nvim/commit/342335889518ceef465d4a38299d80841eaf6daa))
...
* lazy loading doesn't work well with LSP backend ([#173](https://github.com/toantk238/aerial.nvim/issues/173)) ([d453a73](https://github.com/toantk238/aerial.nvim/commit/d453a73279211654f242e86fb6df0f4fca223317))
* limitations with custom floating window options ([#107](https://github.com/toantk238/aerial.nvim/issues/107)) ([5d93978](https://github.com/toantk238/aerial.nvim/commit/5d939786fa22cc4377fcc9678630e47b4db0a9d3))
* loading status when first opening aerial win ([0f65dc4](https://github.com/toantk238/aerial.nvim/commit/0f65dc41e23c713c13c9bfe031b35bf96d7f006a))
* LSP symbol gathering when SelectionRange is missing ([#136](https://github.com/toantk238/aerial.nvim/issues/136)) ([efc597c](https://github.com/toantk238/aerial.nvim/commit/efc597cc70c36ecd2be54256190a0f2c32cde728))
* LSP synchronous symbol fetch when buffer has multiple clients ([#215](https://github.com/toantk238/aerial.nvim/issues/215)) ([7f09d0d](https://github.com/toantk238/aerial.nvim/commit/7f09d0d00360e491cb063ceb56aac9b2d6e5a911))
* lualine separators use default hl group ([#171](https://github.com/toantk238/aerial.nvim/issues/171)) ([56282c9](https://github.com/toantk238/aerial.nvim/commit/56282c9d52307e626e7915f1cf0f34f16c8ac5d6))
...
* man pages shouldn't be ignored by default ([ba60a0b](https://github.com/toantk238/aerial.nvim/commit/ba60a0b1f55a8f0407f653492fbdadab3684125d))
* missing symbol on navigation shouldn't error ([#295](https://github.com/toantk238/aerial.nvim/issues/295)) ([1175f79](https://github.com/toantk238/aerial.nvim/commit/1175f79bdd1e7800b1b65a7f99a7fe47758652ff))
* name captures respect offset metadata ([#247](https://github.com/toantk238/aerial.nvim/issues/247)) ([3721075](https://github.com/toantk238/aerial.nvim/commit/3721075a6903859c4936bdc7e5a4c345f93d3aac))
* nav view doesn't force cursor to col 0 ([#403](https://github.com/toantk238/aerial.nvim/issues/403)) ([f6f74a0](https://github.com/toantk238/aerial.nvim/commit/f6f74a04ba72f87c91a0f533d37e03c24518879a))
* navigating to invalid buffer ([#195](https://github.com/toantk238/aerial.nvim/issues/195)) ([7e2fef6](https://github.com/toantk238/aerial.nvim/commit/7e2fef6ec501a3fe8bc6c4051b3a1014dc098a06))
* navigation issues with volar ([#183](https://github.com/toantk238/aerial.nvim/issues/183)) ([4b42ddb](https://github.com/toantk238/aerial.nvim/commit/4b42ddbd453caec3b12541af80e498a02d47cf20))
* navigation tests ([389a644](https://github.com/toantk238/aerial.nvim/commit/389a644e147a3b15af4606ebad04133c42d3a0d5))
...
* no LSP client found messages ([#249](https://github.com/toantk238/aerial.nvim/issues/249)) ([72813e6](https://github.com/toantk238/aerial.nvim/commit/72813e602039266c37e78075ba7a30e45fbbf52f))
* only allow collapsing leaf nodes if link_tree_to_folds = true ([#257](https://github.com/toantk238/aerial.nvim/issues/257)) ([5c5b355](https://github.com/toantk238/aerial.nvim/commit/5c5b355f29664577738d8843e948d16ff17afe65))
* only set aerial filetype when we are in the aerial buffer ([737d65a](https://github.com/toantk238/aerial.nvim/commit/737d65a75aa12a7365b0bd8d597664ee4271a3b1))
* option filetype maps when default value is false ([#158](https://github.com/toantk238/aerial.nvim/issues/158)) ([e0215f9](https://github.com/toantk238/aerial.nvim/commit/e0215f9dcf55e917f547ad2c688be6fe67a5926d))
* pass bufnr to LSP callback ([#110](https://github.com/toantk238/aerial.nvim/issues/110)) ([95a6f71](https://github.com/toantk238/aerial.nvim/commit/95a6f71af6cad4cad8f2f3873ad012c8ba754b4f))
* **php:** update treesitter query ([#400](https://github.com/toantk238/aerial.nvim/issues/400)) ([8d2a6c2](https://github.com/toantk238/aerial.nvim/commit/8d2a6c2ffad271b10c91f2c6f6ecef1f9625a9b9))
* possible race condition in LspDetach ([85fe530](https://github.com/toantk238/aerial.nvim/commit/85fe53058c84528c0027021913518a656f136830))
* prevent error when symbols have newline ([a13fcd5](https://github.com/toantk238/aerial.nvim/commit/a13fcd5e921c88eaa0a6590d94d8e5694400ef3f))
* provide more info when aerial not supported ([#186](https://github.com/toantk238/aerial.nvim/issues/186)) ([e0f744c](https://github.com/toantk238/aerial.nvim/commit/e0f744c9c3c2b230a717ad9036a03a776c492be6))
* queue commands before aerial attaches to avoid dropped inputs ([#301](https://github.com/toantk238/aerial.nvim/issues/301)) ([847a2a3](https://github.com/toantk238/aerial.nvim/commit/847a2a31fb7d2088e41a13ab58a6f7ff97cdc2dd))
...
* reduce default disable_max_size 10MB-&gt;2MB ([59d257f](https://github.com/toantk238/aerial.nvim/commit/59d257fe8d41c387cae37537f26df0eac84db8a8))
...
* remove debug print statement ([9703f76](https://github.com/toantk238/aerial.nvim/commit/9703f76f3429e1e77a98f2b11b5ee0eb71d65900))
* remove duplicate LSP client checking logic ([#236](https://github.com/toantk238/aerial.nvim/issues/236)) ([24fe657](https://github.com/toantk238/aerial.nvim/commit/24fe657357320cab076eb88d17aae64d014fae38))
...
* remove unused variable ([008caa5](https://github.com/toantk238/aerial.nvim/commit/008caa510d55c442b6a90ab035475052456c9d66))
* **render:** use EOL extmarks to render AerialLine ([#302](https://github.com/toantk238/aerial.nvim/issues/302)) ([568780e](https://github.com/toantk238/aerial.nvim/commit/568780e7c1d3bedace4d54777871e70be41eb3a7))
* resize windows after opening aerial ([#98](https://github.com/toantk238/aerial.nvim/issues/98)) ([eba03e1](https://github.com/toantk238/aerial.nvim/commit/eba03e1cddae498f80ac93d7e0e60c97ef7ec42f))
* return cursor to source window when closing aerial ([#241](https://github.com/toantk238/aerial.nvim/issues/241)) ([a2beef7](https://github.com/toantk238/aerial.nvim/commit/a2beef7cd6b93c1681442c2410c76b98a81166b1))
* return to source window on close ([#192](https://github.com/toantk238/aerial.nvim/issues/192)) ([a95b63f](https://github.com/toantk238/aerial.nvim/commit/a95b63f7dd5676dfbd0989d82ce3f2ee12343696))
* **ruby:** missing methods in treesitter backend ([#382](https://github.com/toantk238/aerial.nvim/issues/382)) ([e75a3df](https://github.com/toantk238/aerial.nvim/commit/e75a3df2c20b3a98c786f5e61587d74a7a6b61d6))
* sanitize bad LSP symbol ranges ([#101](https://github.com/toantk238/aerial.nvim/issues/101)) ([b4a542e](https://github.com/toantk238/aerial.nvim/commit/b4a542e599143237dc82479089c1fd9b7ba4dcba))
* set cursor in aerial window on first open ([ee8d7c8](https://github.com/toantk238/aerial.nvim/commit/ee8d7c8ece287482bf293fe568aa9dcfae62ef8a))
...
* set nolist in aerial window ([#150](https://github.com/toantk238/aerial.nvim/issues/150)) ([0de1bb9](https://github.com/toantk238/aerial.nvim/commit/0de1bb92f6de4a0915e5487ce9e53fb5704028c7))
* silence errors from moving cursor ([#297](https://github.com/toantk238/aerial.nvim/issues/297)) ([551a2b6](https://github.com/toantk238/aerial.nvim/commit/551a2b679f265917990207e6d8de28018d55f437))
* silence invalid buffer errors ([#242](https://github.com/toantk238/aerial.nvim/issues/242)) ([98a5092](https://github.com/toantk238/aerial.nvim/commit/98a50929cf51c806b424b7b0da1de90b5f5dd075))
* stop using vim.wo to set window options ([87f9133](https://github.com/toantk238/aerial.nvim/commit/87f91339901cc64f0a35a26463030a1988ed10dc))
* stuck loading on files with no supported backends ([96346e1](https://github.com/toantk238/aerial.nvim/commit/96346e106dd7d5c1fd76f4b451fc8defc55ddc12))
* symbol count logic for buffer ([1bdaaac](https://github.com/toantk238/aerial.nvim/commit/1bdaaac714cf8dfe44929e19c75b77bc5ff14380))
* symbol sort order when ranges are equal ([#132](https://github.com/toantk238/aerial.nvim/issues/132)) ([f40bb38](https://github.com/toantk238/aerial.nvim/commit/f40bb382b1b2fc6a83fd452cc67bf6ecfba094e3))
* telescope extension can customize col widths ([8be4124](https://github.com/toantk238/aerial.nvim/commit/8be41243cd3644eaeeb574c5e80be36fbc022508))
* telescope extension uses selection_range ([#279](https://github.com/toantk238/aerial.nvim/issues/279)) ([bb2cc2f](https://github.com/toantk238/aerial.nvim/commit/bb2cc2fbf0f5be6ff6cd7e467c7c6b02860f3c7b))
* telescope picker shows symbols in order ([#169](https://github.com/toantk238/aerial.nvim/issues/169)) ([848779f](https://github.com/toantk238/aerial.nvim/commit/848779f03d038be951d0b8f73313e4d3388dabe4))
* **telescope:** guard against missing treesitter parser in preview ([603156d](https://github.com/toantk238/aerial.nvim/commit/603156d4fd58963a05f221e76b1a25bc79ed55b0))
* tree collapsing works again (broken in 3a482fe) ([#112](https://github.com/toantk238/aerial.nvim/issues/112)) ([ece90c4](https://github.com/toantk238/aerial.nvim/commit/ece90c4820e7cea7be0aade9d19ef11f53bbc028))
* tree folding bug when symbols have the same name ([d2a1296](https://github.com/toantk238/aerial.nvim/commit/d2a12969b2a7f831b796469f75831f0cb242c086))
* **treesitter:** explicitly set all to false in iter_matches ([#407](https://github.com/toantk238/aerial.nvim/issues/407)) ([3c04b04](https://github.com/toantk238/aerial.nvim/commit/3c04b040a81b800125d7f68f5579892d6bce854d))
* **ts:** improve ruby handling of singletons and methods ([#293](https://github.com/toantk238/aerial.nvim/issues/293)) ([a2368d1](https://github.com/toantk238/aerial.nvim/commit/a2368d1c4bdb149679fbcbd16a288e5e0bee8156))
* type annotations and type errors ([ffb5fd0](https://github.com/toantk238/aerial.nvim/commit/ffb5fd0aa7fcd5c3f68df38f89af3aa007f76604))
* update deprecated nerd font icons ([8a59ed2](https://github.com/toantk238/aerial.nvim/commit/8a59ed2dc9563833ee0277b5bfd2e06faf95c2ab))
* update julia queries for new TS parser ([97279a1](https://github.com/toantk238/aerial.nvim/commit/97279a10cc797af96d3e7295026e51e4968d09a1))
* update julia queries for upstream parser changes ([e22facd](https://github.com/toantk238/aerial.nvim/commit/e22facd3a696f4690f888e16ddaba585c8173e4e))
* update markdown ts query for breaking parser change ([85baf29](https://github.com/toantk238/aerial.nvim/commit/85baf29b09bc19b2723a703df9e58a2563648c35))
* update tests for new norg parser ([490b574](https://github.com/toantk238/aerial.nvim/commit/490b574a66a0f7058b0ad10004a62054e0558075))
...
* use relative url for submodule definition ([#264](https://github.com/toantk238/aerial.nvim/issues/264)) ([c50874a](https://github.com/toantk238/aerial.nvim/commit/c50874a2943699397fc6c19102e7c67e2f832041))
* use selection_range for navigation ([#132](https://github.com/toantk238/aerial.nvim/issues/132)) ([0a8c2c5](https://github.com/toantk238/aerial.nvim/commit/0a8c2c57bae3a8ba1209b5f54e7c2de75e862fc2))
...
* warning when closing buffers with the LSP backend in place ([#397](https://github.com/toantk238/aerial.nvim/issues/397)) ([b092d63](https://github.com/toantk238/aerial.nvim/commit/b092d6373d563dc28187a0a340e3daaefc14fc62))
* **zig:** update queries for new zig treesitter parser ([491e2fc](https://github.com/toantk238/aerial.nvim/commit/491e2fc5640a34dc7f2f6b490670543d17fbc220))


### Performance Improvements

* slight optimization for telescope picker ([aff1bb8](https://github.com/toantk238/aerial.nvim/commit/aff1bb8fecff83d3e3a2d544c4d4e6d65718bd19))


### Code Refactoring

* drop support for Neovim 0.8 ([#387](https://github.com/toantk238/aerial.nvim/issues/387)) ([b309d0d](https://github.com/toantk238/aerial.nvim/commit/b309d0df6b59923a2155f5a8b7ef99777b3311c9))
* Link aerial to a source window, not a buffer ([#128](https://github.com/toantk238/aerial.nvim/issues/128)) ([d1e0bcd](https://github.com/toantk238/aerial.nvim/commit/d1e0bcd3458204ffaa8fdf311e97abbcc8ce84b7))
* split close_behavior into two new config options ([8e1d575](https://github.com/toantk238/aerial.nvim/commit/8e1d57562da73dc706165e02ec3228749d73c5f5))
